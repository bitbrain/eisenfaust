    ...
    <div class="landing-container">
      ...
      <div class="section-container">
       ...
       <div id="join-section" class="section-content">
        ...
        <Divider>Ruhm</Divider>
        <ul>
          <li>du spielst einen Dünir-Zwerg</li>
          <li>du bist mindestens 18 Jahre alt</li>
          <li>du bist auf unserem Discord aktiv</li>
          <li>du besitzt einen <a href="https://ashesofcreation.com/shop" target="_blank" rel="noopener noreferrer">Alpha-Key</a></li>
        </ul>
